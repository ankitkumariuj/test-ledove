...
const openQuickView = async (pid , type = null) => {
    ...
    //             console.log(product.single_image);
    ...
    //                     h_product_view_imgs += `
    //                         <img class="${isActive}" src="${image_url + 'variant/main/' + product.single_image}" onclick="quickViewChangeImg(this)" alt="">
    //                     `;
    //                 });
    //             } else {
    //                 h_product_view_imgs += `
    //                     <img class="active" src="${image_url + 'variant/main/' + product.single_image}" onclick="quickViewChangeImg(this)" alt="">
    //                 `;
    //             }
